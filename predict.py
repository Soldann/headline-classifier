...
class Predict:
    def __init__(self,training_csv: str, filter_stop_words=True, stem_words=True) -> None:
        self.word_to_category_probabilities, self.category_probabilities, self.default_probability = probabilities.get_probabilities('training.csv',filter_stop_words,stem_words)
